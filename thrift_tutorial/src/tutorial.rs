...
impl CalculatorPingArgs {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorPingArgs> {
        i_prot.read_struct_begin()?;
        loop {
            let field_ident = i_prot.read_field_begin()?;
            if field_ident.field_type == TType::Stop {
...
impl CalculatorPingResult {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorPingResult> {
        i_prot.read_struct_begin()?;
        loop {
            let field_ident = i_prot.read_field_begin()?;
            if field_ident.field_type == TType::Stop {
...
impl CalculatorAddArgs {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorAddArgs> {
        i_prot.read_struct_begin()?;
...
impl CalculatorAddResult {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorAddResult> {
        i_prot.read_struct_begin()?;
...
impl CalculatorCalculateArgs {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorCalculateArgs> {
        i_prot.read_struct_begin()?;
        let mut f_1: Option<i32> = None;
...
impl CalculatorCalculateResult {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorCalculateResult> {
        i_prot.read_struct_begin()?;
        let mut f_0: Option<i32> = None;
...
impl CalculatorZipArgs {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<CalculatorZipArgs> {
        i_prot.read_struct_begin()?;
        loop {
            let field_ident = i_prot.read_field_begin()?;
            if field_ident.field_type == TType::Stop {
