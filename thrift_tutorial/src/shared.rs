...
use thrift::protocol::{TFieldIdentifier, TListIdentifier, TMapIdentifier, TMessageIdentifier,
                       TMessageType, TInputProtocol, TOutputProtocol, TSetIdentifier, TStructIdentifier, TType};
...
impl TSharedServiceProcessFunctions {
    pub fn process_get_struct<H: SharedServiceSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut TInputProtocol, o_prot: &mut TOutputProtocol) -> thrift::Result<()> {
...
impl SharedServiceGetStructArgs {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SharedServiceGetStructArgs> {
        i_prot.read_struct_begin()?;
...
impl SharedServiceGetStructResult {
    fn read_from_in_protocol(i_prot: &mut TInputProtocol) -> thrift::Result<SharedServiceGetStructResult> {
        i_prot.read_struct_begin()?;
