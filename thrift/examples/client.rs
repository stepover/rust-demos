...
use thrift::transport::{
    ReadHalf, TIoChannel, TTcpChannel, WriteHalf,
...
fn run() -> thrift::Result<()> {
    let options = clap_app!(rust_tutorial_client =>
        ...
        (@arg host: --host +takes_value "host on which the tutorial thrift_tutorial_server listens")
    ...
    // let's start with a ping; the thrift_tutorial_server should respond
    println!("ping!");
    client.ping()?;
